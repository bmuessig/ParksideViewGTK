...
namespace ParksideViewGTK
{
    ...
    internal static class Language
    {
        ...
        public const string SaveDialogAccept = "Speichern";
        public const string SaveDialogCancel = "Abbrechen";
        public const string CSVVersionFormat = "ParksideViewGTK {0} von Benedikt Müssig";
        ...
        public const string SaveDialogAccept = "Save";
        public const string SaveDialogCancel = "Cancel";
        public const string CSVVersionFormat = "ParksideViewGTK {0} by Benedikt Müssig";
